...
<body>
     <div class="container">
          <h1 align="center">Modificar Cotización</h1>

          <form action="../../Controlador/ControladorCotizacion.php" method="post">
               <div class="form-row" >
                    <div class="form-group col-md-4">
                         <label for="">Id Empresa</label>
                         <input type="text" class="form-control" id="IdEmpresa" name="IdEmpresa" value="<?php echo $Cotizacion->getIdEmpresa();?>">
                    </div>
                    <div class="form-group col-md-4">
               ...
               <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                         ...
                         <input type="text" class="form-control" id="Lozas" name="Lozas" value="<?php echo $Cotizacion->getLozas();?>">
                    </div>
                    <div class="form-group col-md-4">
               ...
               <div class="form-row">
                    <div class="form-group col-md-4">
                         ...
                         <input type="text" class="form-control" id="Tuberia" name="Tuberia" value="<?php echo $Cotizacion->getTuberia();?>">
                    </div>
                    <div class="form-group col-md-4">
